...
//   // Fetch vitals list when modal opens
...
//   // Fetch investigations list when modal opens
...
//     // Build vitals object from vitalsValues state
...
//               </Button>
//             </div>
//             {Object.keys(vitalsValues).filter((k) => vitalsValues[k]).length >
//             0 ? (
...
//                       </span>
//                       <button
//                         onClick={() => toggleSelectInvestigation(inv.uid)}
//                         className="ml-1"
//                       >
//                         <IconX
//                           size={14}
...
//                   onClick={() => toggleSelectInvestigation(investigation.uid)}
//                 >
//                   <div className="flex items-center justify-between">
//                     <div className="flex-1">
//                       <label className="text-sm font-medium text-black">
...
//                       )}
//                       onChange={() =>
//                         toggleSelectInvestigation(investigation.uid)
//                       }
...
//               Cancel
//             </Button>
//             <Button onClick={confirmInvestigations}>
...
//                         value={value}
//                         onChange={(e) =>
//                           updateVitalValue(vital.key, e.currentTarget.value)
//                         }
//                         className="w-24"
//                         size="sm"
//                         styles={{
...
//               Cancel
//             </Button>
//             <Button onClick={confirmVitals}>Confirm Vitals</Button>
//           </div>
//         </div>
//       </Modal>
